...
const userPdfs = [
  { 
    ...
    docs: [
      { id: 1, label: "Australia LMI", path: "/MD Mezanur Rahaman Australia Lmi.pdf" },
      { id: 2, label: "Job Letter", path: "/Australia job leter-8-kaz ok (1).pdf" },
      { id: 3, label: "Work Permit", path: "/MD MEZANUR RAHAMAN Australia work permity-3 kaz ok.pdf" },
      ...
      <div className="bg-white shadow-2xl rounded-3xl overflow-hidden w-full max-w-5xl transition-all">
        ...
        {!activeUser ? (
          <div className="p-12 max-w-md mx-auto text-center">
            ...
            <h1 className="text-3xl font-extrabold text-slate-800 mb-2">Secure Portal</h1>
            <p className="text-slate-500 mb-8">Enter your unique credential to access your visa documents.</p>
          ...
          <div className="p-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-rose-50 text-rose-600 font-bold rounded-lg hover:bg-rose-100 transition"
              >
                <span>Logout</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {activeUser.docs.map((doc) => (
                <div key={doc.id} className="group relative bg-slate-50 border border-slate-100 p-6 rounded-2xl hover:bg-white hover:shadow-xl hover:border-blue-200 transition-all duration-300">
                  ...
                  <p className="text-xs text-slate-400 mb-6 uppercase tracking-tighter">Official PDF Document</p>
            ...
            {selectedFile && (
              <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm z-50 p-4 md:p-10 flex flex-col">
                ...
                <div className="flex-grow bg-white rounded-2xl overflow-hidden">
                  <iframe src={selectedFile} className="w-full h-full" title="PDF Preview" />
                </div>
              </div>
            )}
          </div>
